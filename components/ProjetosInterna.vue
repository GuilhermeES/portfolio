<template>
    <section class="projetos-interna">
        <div class="container">
            <div class="projetos-interna__banner">
                ...
                <div class="projetos-interna__text">
                    <h1>Projetos</h1>
                    <p>Alguns dos principais projetos em que estive envolvido</p>
                </div>
                <div class="projetos-interna__banner-img">
                    <img src="/img/gui_cafe.svg" alt="Guilherme">
                </div>
            </div>
